...
//DONT USE ANY Thread.sleep(xxx), instead use Awaitility  or a runTest{} with delay(). Main looper wont be available.
class UITestSignInOrRegister {
    ...
    fun `test Login works`() {
        ...
        androidComposeTestRule.onNodeWithText(context.getString(R.string.user_email)).performTextInput("write a valie email address")
        androidComposeTestRule.onNodeWithText(context.getString(R.string.user_password)).performTextInput("write a valid password")
        Thread.sleep(1000)
    ...
    fun `test register works`() {
        ...
        androidComposeTestRule.onNodeWithText(context.getString(R.string.new_user_email)).performTextInput("write a valid email address")
        androidComposeTestRule.onNodeWithText(context.getString(R.string.new_user_password)).performTextInput("write a valid password")
        androidComposeTestRule.onNodeWithText(context.getString(R.string.new_user_repeat_password)).performTextInput("repeat valid password")
        Thread.sleep(1000L)
